...
public class ClientOrders extends AppCompatActivity {
    ...
    private AdaptOrder adapter;
    private RecyclerView recyclerView;
    private String baseUrl = "http://192.168.100.23/LoginRegister/clientOrders.php?email=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new AdaptOrder(this,list,mail);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        dialog.dismiss();
                        Toast.makeText(ClientOrders.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                });
