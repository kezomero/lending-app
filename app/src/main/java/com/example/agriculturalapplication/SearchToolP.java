...
public class SearchToolP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_tool_p);
        ...
        list = new ArrayList<>();
        adapter = new AdaptP(this, list, mail);
        ...
        final StringRequest request = new StringRequest("http://192.168.100.23/LoginRegister/viewDataP.php", new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                dialog.dismiss();
                Toast.makeText(SearchToolP.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void m(View view) {
        Intent n = new Intent(getApplicationContext(), ToolDetailsP.class);
        n.putExtra("mail", mail);
        startActivity(n);
    }
