...
public class Store extends AppCompatActivity {
    ...
    String mail;
    private List<ModelStore> list;
    private AdaptStore adapter;
    private RecyclerView recyclerView;
    private String baseUrl = "http://192.168.100.23/LoginRegister/store.php?email=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new AdaptStore(this,list,mail);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            for (int loop = 0; loop < response.length(); loop++) {
                                ...
                                list.add(new ModelStore(object.getString("name"),
                                        object.getString("id"),
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        dialog.dismiss();
                        Toast.makeText(Store.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                });
