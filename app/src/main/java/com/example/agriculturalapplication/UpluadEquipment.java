...
public class UpluadEquipment extends AppCompatActivity {
    TextView titleTextView,fileNameTextView;
    private LinearLayout hm;
    public static final int STORAGE_PERMISSION_CODE = 4655;
    EditText name, make, category, cost, ovCost, contact, county, location, days;
    Bitmap imageToStore;
    Uri imagePath;
    Button choose;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upluad_equipment);
        ...
        ovCost = findViewById(R.id.overdue);
    ...
    public void saveData(View view) {
        ...
        String ovc = ovCost.getText().toString();
        String cnt = contact.getText().toString();
        String cnty = county.getText().toString();
        String loc = location.getText().toString();
        String dy = days.getText().toString();

        if (imageToStore!=null&&!nm.isEmpty() && !mk.isEmpty() && !ctg.isEmpty() && !cst.isEmpty() && !ovc.isEmpty() && !cnt.isEmpty() && !mail.isEmpty() && !cnty.isEmpty() && !loc.isEmpty() && !dy.isEmpty()) {
            ...
            String url ="http://192.168.100.23/LoginRegister/tool.php";
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if(response.equals("success")){
                                ...
                                days.setText(null);
                                Toast.makeText(getApplicationContext(), "Tool Uploaded", Toast.LENGTH_SHORT).show();
                            }else{
