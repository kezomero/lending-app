...
public class MyOrdersP extends AppCompatActivity {
    ...
    private AdaptMyOrder adapter;
    private RecyclerView recyclerView;
    private String baseUrl = "http://192.168.100.23/LoginRegister/toolOrders.php?email=";
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_orders_p);
        ...
        list = new ArrayList<>();
        adapter = new AdaptMyOrder(this,list,mail);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            for (int loop = 0; loop < response.length(); loop++) {
                                ...
                                list.add(new ModelOrder(object.getString("name"),
                                        object.getString("id"),
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        dialog.dismiss();
                        Toast.makeText(MyOrdersP.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                });
