...
public class Purchase extends AppCompatActivity {
    ...
    EditText name, contact, quantity, county, location;
    Bitmap imageToStore;
    Uri imagePath;
    Button choose;
    String mail;
    ...
    public void saveData(View view) {
        ...
        String contactSeller = getIntent().getStringExtra("contact");
        String id = getIntent().getStringExtra("id");
        String ml=getIntent().getStringExtra("email");

        if (imageToStore!=null&&!nm.isEmpty()&& !mail.isEmpty() && !cnty.isEmpty() && !loc.isEmpty() && !conta.isEmpty()&& !quant.isEmpty()&& !contactSeller.isEmpty()) {
            ...
            String url ="http://192.168.100.23/LoginRegister/toolHiringP.php";
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                protected Map<String, String> getParams(){
                    ...
                    paramV.put("contactSeller", contactSeller);
